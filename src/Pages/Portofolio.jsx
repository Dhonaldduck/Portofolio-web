...
const techStacks = [
  ...
  { icon: "adobeillustrator.svg", language: "Adobe Illustrator" },
  { icon: "burpsuite.svg", language: "Burpsuite" },
  { icon: "oracle.svg", language: "Oracle" },
  { icon: "npm.svg", language: "npm" },
  { icon: "gcp.svg", language: "GoogleCloudPlatform" },
  { icon: "firebase.svg", language: "Firebase" },
  ...
  { icon: "Wireshark.svg", language: "Wireshark" },
  { icon: "autodesk.svg", language: "Autodesk" },
  { icon: "vmware.svg", language: "Vmware" },
  { icon: "archlinux.svg", language: "Archlinux" },
  { icon: "linux.svg", language: "Linux" },
  { icon: "Metasploit.svg", language: "Metasploit" },
  { icon: "github.svg", language: "Github" },
  { icon: "kalilinux.svg", language: "Kalilinux" },
];
